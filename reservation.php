...
<div class="container-fluid p-3 p-md-4">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
    <div class="fs-4 text-white fw-bolder">Requests Records </div>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                        <button type="button" class="btn btn-secondary editbtn" data-toggle="modal" data-target="#viewtmodal_<?php echo $row['id']; ?>">
                        <i class="bi bi-eye"></i>
                        </button> 
                       ...
                       <!-- Accept modal -->
              <div class="modal fade" id="viewtmodal_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          <div class="modal-header" style="background-color: #A569BD;">
                              <h3 class="modal-title text-white" id="exampleModalLabel">Facilities/Equipment Requested</h3>
                              <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">×</span>
                              </button>
                          </div>
                          <div class="modal-body">                           
                          <strong><h4>Date Requested:</strong> <?php echo $row['datetoday']; ?></h4></strong>
                              <br>
                             <strong><h5>Requested Equipment:</strong> &nbsp; <?php echo $row['equipment']; ?></h5>                         
                             <strong><h5>Requested Party:</strong>  &nbsp; <?php echo $row['reqparty']; ?></h5>
                             <strong><h5>Requested Department:</strong> &nbsp;  <?php echo $row['department']; ?></h5>
                             <strong><h5>Date to be Barrowed:</strong>  &nbsp; <?php echo $row['fromm']; ?>
                                  - <?php echo $row['too']; ?></h5>
                              <strong><h5>Requested Status:</strong> &nbsp; <?php echo $row['label']; ?></h5> 
...
<script>
    ...
    <script>
        // This code is for  current date and time
