...
<div class="container-fluid p-3 p-md-4">
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
    <div class="fs-4 text-white fw-bolder">Pending Requests </div>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                        <button type="button" class="btn btn-primary editbtn" data-toggle="modal" data-target="#acceptmodal_<?php echo $row['id']; ?>">
                          <i class="bi bi-check2-square"></i>
                        </button> 

                        <button type="button" class="btn btn-danger editbtn" data-toggle="modal" data-target="#declinemodal_<?php echo $row['id']; ?>">
                       ...
                       <!-- Accept modal -->
              <div class="modal fade" id="acceptmodal_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          <div class="modal-header bg-primary">
                              <h3 class="modal-title text-white" id="exampleModalLabel">Accept Equipment Request</h3>
                              <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">×</span>
                              </button>
                          </div>
                          <div class="modal-body">
                              <h4>Facilities/Equipment Requested</h4>
                              <br>
                          ...
                          <div class="modal-footer">
                              <form action="process.php?id=<?php echo $row['id']; ?>" method="POST">
                                  ...
                                  <input type="submit" name="accept_request" value="Accept" class="btn btn-primary btn-lg">
                              </form>
                          </div>
                      </div>
                  </div>
              ...
              <!-- Decline modal -->
              <div class="modal fade" id="declinemodal_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          <div class="modal-header bg-danger">
                              <h3 class="modal-title text-white" id="exampleModalLabel">Deline Equipment Request</h3>
                              <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">×</span>
                              </button>
                          </div>
                          ...
                          <div class="modal-footer">
                              <form action="process.php?id=<?php echo $row['id']; ?>" method="POST">
                                   <button class="btn btn-secondary btn-lg" type="button" data-dismiss="modal">Cancel</button>
                                  <input type="submit" name="decline_request" value="Confirm" class="btn btn-danger btn-lg">
                              </form>
                          </div>
                      </div>
                  </div>
